    ...
    <div className="mx-auto max-w-5xl space-y-8">
      ...
      <div className="space-y-8">
        <section className="surface-card rounded-2xl p-5 text-sm text-muted">
          <div className="mb-2 font-semibold text-content">Agent 快速流程</div>
        ...
        <section className="space-y-3">
          <div className="text-sm font-semibold text-content">核心接口</div>
        ...
        <section className="surface-card rounded-2xl p-5 text-sm text-muted">
          <div className="mb-2 font-semibold text-content">调试提示</div>
